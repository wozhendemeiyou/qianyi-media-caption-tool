...
本手册对应 v3.6.1。公开版不带 API Key 和提示词模板，所有凭据与模板均由用户在自己的 Windows 账户中配置。
...
> **v3.5 / 初始 v3.6 升级提示：**旧版更新器使用了不兼容的 Windows 独立进程标志，可能在下载完成后没有执行覆盖和重启。请从 GitHub Release 手动运行一次 v3.6.1；从 v3.6.1 开始，后续版本可恢复软件内自动更新。
